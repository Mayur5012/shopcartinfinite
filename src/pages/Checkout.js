      ...
      {status === 'loading' ? (
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 ">
          <div className="lg:col-span-3">
            ...
            <form
              className="bg-white px-5 py-12 mt-12 shadow-md rounded-lg"
              noValidate
            ...
            <div className='bg-white mt-8 px-5 py-5 rounded-lg shadow-lg'>
              ...
              <ul className='space-y-5 mt-4'>
                {user.addresses.map((address, index) => (
                  <li
                    key={index}
                    className="flex justify-between border p-5 rounded-lg shadow-md"
                  >
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-2 lg:px-4 shadow-md rounded-lg">
