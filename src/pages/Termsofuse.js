...
import img from '../../src/assests/image2.png';

const Termsofuse = () => {
  return (
    <>
      <div className="flex justify-center items-center mt-6">
        <img className="max-w-xs" src={img} alt="Shopcart Logo" />
      </div>

      <div className="min-h-full bg-white text-grey-800 p-8">
        <div className="mx-auto max-w-2xl">
          <h1 className="text-3xl font-bold text-center mb-8">
            Terms of Service for Shopcart
          </h1>
          
        </div>

        <div className="mb-4">
          <h3 className="text-2xl font-bold text-left mb-4">Overview</h3>
          <p className="text-justify">
          This website is operated by Shopcart. Throughout the site, the
          terms “we”, “us” and “our” refer to Shopcart. Shopcart
        ...
        <div className="mb-4"><p className="text-justify">
          <p className="font-bold">SECTION 1 - ONLINE STORE TERMS </p>
        ...
        <div className="mb-4"><p className="text-justify">
          <p className="font-bold">SECTION 2 - GENERAL CONDITIONS</p> We reserve the right to refuse service
          ...
          convenience only and will not limit or otherwise affect these terms.
            ...
            By buying a product from Zillionaire you agree to give permission to
            Zillionaire for using your photo/video content where you're using a
            Zillionaire product, for re-sharing on Zillionaire's social and
            promotional handles as stories, posts, reels or ad content or for
            use on website, without asking for your written permission.
          </p></div>
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</p> We
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</p> Prices for our
            products are subject to change without notice. We reserve the right
            at any time to modify or discontinue the Service (or any part or
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</p> Certain products or
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</p> We reserve
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 7 - OPTIONAL TOOLS</p> We may provide you with access to
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 8 - THIRD-PARTY LINKS</p> Certain content, products and services
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS </p>
            If, at our
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 10 - PERSONAL INFORMATION</p> Your submission of personal
            information through the store is governed by our Privacy Policy. To
            view our Privacy Policy.
          </p></div>
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</p>
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 12 - PROHIBITED USES</p> In addition to other prohibitions as
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</p> We do
            ...
            Shopcart, our directors, officers, employees, affiliates,
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 14 - INDEMNIFICATION </p>
            You agree to indemnify, defend and hold
            harmless Shopcart and our parent, subsidiaries, affiliates,
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 15 - SEVERABILITY</p>
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 16 - TERMINATION</p>
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 17 - ENTIRE AGREEMENT</p>
          ...
          <div className="mb-4"><p className="text-justify">
            <p className="font-bold">SECTION 20 - CONTACT INFORMATION</p>
             Questions about the Terms of
            Service should be sent to us at team.Shopcart@gmail.com.
          </p></div>
        </div>
